...
import Search from "../chatList/Search";
...
const SideBar = () => {
  ...
  return (
    <div className="open_main__chatlist noman">
      <div className="name_photo">
        <img src={firebaseUser.photoURL} alt="" className="yaur____photo" />
        <hp>{firebaseUser.displayName}</hp>
      </div>
      <div className="open_chatlist__heading">
        <h2>Chats</h2>
